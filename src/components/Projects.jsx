...
import resultManagementImg from '../assets/resultmanagement.png';
...
const projects = [
  {
    ...
    title: "Career Nexus",
    description:
      "Career Nexus is a full-stack job portal built using the MERN stack, enabling users to browse, filter, and apply for jobs with ease. It includes an admin panel for companies to manage listings and a course section to help users upskill and boost job eligibility.",
    link: "https://career-nexus-platform.vercel.app/",
  ...
  },
  {
    ...
    link: "https://result-management-system-psi.vercel.app/",
    image: resultManagementImg,
  ...
  },
  {
    ...
    description:
      "An e-commerce website where I enhanced features, added new functionalities, and fixed bugs to improve user experience.",
    link: "https://aapkabazar.co/",
    image: eCommerceImg,
